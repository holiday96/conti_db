...
CREATE TABLE `order_detail`  (
  ...
  `created_date` datetime NOT NULL,
  `modified_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_orders_order_detail`(`order_id`) USING BTREE,
  INDEX `fk_order_detail_products`(`product_id`) USING BTREE,
  CONSTRAINT `fk_order_detail_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_orders_order_detail` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `products` VALUES (31, 1, 'Táo', 'Táo tươi và mọng nước.', 'https://upload.wikimedia.org/wikipedia/commons/1/15/Red_Apple.jpg', 20000, 100, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (32, 1, 'Chuối', 'Chuối ngọt và chín.', 'https://upload.wikimedia.org/wikipedia/commons/8/8a/Banana-Single.jpg', 15000, 150, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (33, 1, 'Cà rốt', 'Cà rốt giòn.', 'https://upload.wikimedia.org/wikipedia/commons/3/3d/Carrot.JPG', 18000, 200, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (34, 1, 'Dưa leo', 'Dưa leo tươi.', 'https://upload.wikimedia.org/wikipedia/commons/9/9b/Cucumis_sativus.jpg', 12000, 250, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (35, 1, 'Cà chua', 'Cà chua hữu cơ.', 'https://upload.wikimedia.org/wikipedia/commons/8/88/Bright_red_tomato_and_cross_section02.jpg', 25000, 300, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (36, 2, 'Cam', 'Cam ngọt và mọng nước.', 'https://upload.wikimedia.org/wikipedia/commons/c/c4/Orange-Fruit-Pieces.jpg', 30000, 100, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (37, 2, 'Xà lách', 'Xà lách tươi và giòn.', 'https://upload.wikimedia.org/wikipedia/commons/b/bf/Lettuce_Mini_Heads.jpg', 10000, 150, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (38, 2, 'Xoài', 'Xoài chín và mọng nước.', 'https://upload.wikimedia.org/wikipedia/commons/9/90/Hapus_Mango.jpg', 35000, 200, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (39, 2, 'Bông cải xanh', 'Bông cải xanh tươi.', 'https://upload.wikimedia.org/wikipedia/commons/0/03/Broccoli_and_cross_section_edit.jpg', 27000, 250, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (40, 2, 'Ớt chuông', 'Ớt chuông đỏ và xanh.', 'https://upload.wikimedia.org/wikipedia/commons/5/57/Capsicum_annuum_fruits_IMGP0049.jpg', 32000, 300, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (41, 3, 'Dâu tây', 'Dâu tây hữu cơ.', 'https://upload.wikimedia.org/wikipedia/commons/2/29/PerfectStrawberry.jpg', 40000, 100, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (42, 3, 'Cải bó xôi', 'Cải bó xôi tươi.', 'https://upload.wikimedia.org/wikipedia/commons/e/e3/Spinacia_oleracea_Spinazie_bloeiend.jpg', 15000, 150, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (43, 3, 'Dưa hấu', 'Dưa hấu mọng nước.', 'https://upload.wikimedia.org/wikipedia/commons/f/fd/Watermelon_cross_BNC.jpg', 20000, 200, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (44, 3, 'Dứa', 'Dứa ngọt.', 'https://upload.wikimedia.org/wikipedia/commons/c/cb/Pineapple_and_cross_section.jpg', 25000, 250, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (45, 3, 'Nho', 'Nho ngon.', 'https://upload.wikimedia.org/wikipedia/commons/1/13/Table_grapes_on_white.jpg', 30000, 300, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (46, 4, 'Bơ', 'Bơ dinh dưỡng.', 'https://upload.wikimedia.org/wikipedia/commons/f/f9/Avocado_-_whole_and_halved.jpg', 45000, 100, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (47, 4, 'Đậu que', 'Đậu que tươi.', 'https://upload.wikimedia.org/wikipedia/commons/8/89/Phaseolus_vulgaris_-_Beans.jpg', 18000, 150, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (48, 4, 'Bí ngòi', 'Bí ngòi tươi.', 'https://upload.wikimedia.org/wikipedia/commons/7/75/Patisson.jpg', 22000, 200, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (49, 4, 'Lê', 'Lê mọng nước.', 'https://upload.wikimedia.org/wikipedia/commons/1/1c/Pears.jpg', 26000, 250, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (50, 4, 'Anh đào', 'Anh đào ngọt.', 'https://upload.wikimedia.org/wikipedia/commons/b/bb/Cherry_Stella444.jpg', 50000, 300, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (51, 5, 'Bí đỏ', 'Bí đỏ hữu cơ.', 'https://upload.wikimedia.org/wikipedia/commons/6/6b/European_hokkaido_pumpkin.jpg', 10000, 100, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (52, 5, 'Cà tím', 'Cà tím tươi.', 'https://upload.wikimedia.org/wikipedia/commons/1/1b/Aubergine.jpg', 20000, 150, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (53, 5, 'Khoai lang', 'Khoai lang dinh dưỡng.', 'https://upload.wikimedia.org/wikipedia/commons/4/4b/Cooked_Sweet_Potatoes.jpg', 25000, 200, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (54, 5, 'Củ cải', 'Củ cải giòn.', 'https://upload.wikimedia.org/wikipedia/commons/4/4b/Edible_Radish.jpg', 15000, 250, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (55, 5, 'Củ dền', 'Củ dền tươi.', 'https://upload.wikimedia.org/wikipedia/commons/6/6f/Beetroot_jm26647.jpg', 20000, 300, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (56, 6, 'Cải xoăn', 'Cải xoăn dinh dưỡng.', 'https://upload.wikimedia.org/wikipedia/commons/7/7e/Kale-Bundle.jpg', 25000, 100, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (57, 6, 'Dưa gang', 'Dưa gang mọng nước.', 'https://upload.wikimedia.org/wikipedia/commons/5/5a/Cantaloupe.jpg', 30000, 150, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (58, 6, 'Bắp', 'Bắp ngọt.', 'https://upload.wikimedia.org/wikipedia/commons/7/76/Corn_on_the_cob.jpg', 22000, 200, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (59, 6, 'Việt quất', 'Việt quất tươi.', 'https://upload.wikimedia.org/wikipedia/commons/4/4d/Blueberries_.jpg', 40000, 250, 'kg', 1, '2024-06-16 07:44:11', 'admin');
INSERT INTO `products` VALUES (60, 6, 'Trái sung', 'Trái sung ngon.', 'https://upload.wikimedia.org/wikipedia/commons/3/31/Ficus_carica_Figs_03.jpg', 50000, 300, 'kg', 1, '2024-06-16 07:44:11', 'admin');
